...
------------ | ------------- | ------------- | -------------
*OpenAPIClient.APIs.DefaultApi* | [**GetApiAllJson**](DefaultApi.md#getapialljson) | **GET** /api/all.json | All Products
*OpenAPIClient.APIs.DefaultApi* | [**GetApiProductCycleJson**](DefaultApi.md#getapiproductcyclejson) | **GET** /api/{product}/{cycle}.json | Single cycle details
*OpenAPIClient.APIs.DefaultApi* | [**GetApiProductJson**](DefaultApi.md#getapiproductjson) | **GET** /api/{product}.json | Get All Details


## Documentation For Models

 - [OpenAPIClient.Models.Cycle](Cycle.md)
 - [OpenAPIClient.Models.CycleCycle](CycleCycle.md)
 - [OpenAPIClient.Models.CycleDiscontinued](CycleDiscontinued.md)
 - [OpenAPIClient.Models.CycleEol](CycleEol.md)
 - [OpenAPIClient.Models.CycleLts](CycleLts.md)
 - [OpenAPIClient.Models.CycleSupport](CycleSupport.md)
