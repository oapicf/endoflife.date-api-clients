...
public interface ApiApi {
    ...
    default ResponseEntity<Cycle> getApiProductCycleJson(
        ...
        @Parameter(name = "cycle", description = "Release Cycle for which the details must be fetched", required = true, in = ParameterIn.PATH) @PathVariable("cycle") String cycle
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
