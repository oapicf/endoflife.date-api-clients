...
#
package WWW::OpenAPIClient::Object::CycleLts;
...
__PACKAGE__->class_documentation({description => 'Whether this release cycle has long-term-support (LTS), or the date it entered LTS status.',
                                  class => 'CycleLts',
                                  required => [], # TODO
}                                 );
