...
defmodule EndoflifeDate.Connection do
  ...
  @doc """
  Configure a EndoflifeDate client.

  ### Parameters

  - `options`: an optional keyword list of EndoflifeDate.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:endoflife_date, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - EndoflifeDate 1.0.0 - elixir"
        )
      )
