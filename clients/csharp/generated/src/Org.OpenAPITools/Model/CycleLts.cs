...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class CycleLts : IValidatableObject
    {
        /// <summary>
        ...
        internal CycleLts(Option<string?> @string, Option<bool?> @bool)
        {
            StringOption = @string;
            BoolOption = @bool;
            OnCreated();
    ...
    public class CycleLtsJsonConverter : JsonConverter<CycleLts>
    {
        ...
        public override CycleLts Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new CycleLts(varStringParsedValue, varBoolParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="CycleLts" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cycleLts"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CycleLts cycleLts, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (cycleLts.StringOption.IsSet && cycleLts.StringOption.Value != null)
                writer.WriteString("support", cycleLts.StringOption.Value);

            if (cycleLts.BoolOption.IsSet && cycleLts.BoolOption.Value != null)
                writer.WriteBoolean("support", cycleLts.BoolOption.Value.Value);

            WriteProperties(writer, cycleLts, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CycleLts" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cycleLts"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CycleLts cycleLts, JsonSerializerOptions jsonSerializerOptions)
        {
