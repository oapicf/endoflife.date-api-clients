...
- API version: 0.0.1
- Build date: 2026-08-12T05:02:12.544134237Z[Etc/UTC]
...
```
cargo run --example openapi_client-client GetApiAllJson
```
...
```toml
[dependencies]
openapi_client = { version = "0.0.1", default-features = false, features = ["client", "server"] }
```

**For server with callbacks that need HTTPS:**
```toml
[dependencies]
openapi_client = { version = "0.0.1", features = ["server", "client-tls"] }
```
...
------------- | ------------- | -------------
[**get-api-all.json**](docs/default_api.md#get-api-all.json) | **GET** /api/all.json | All Products
[**get-api-:product.json**](docs/default_api.md#get-api-:product.json) | **GET** /api/{product}.json | Get All Details
[**get-api-:product-:cycle.json**](docs/default_api.md#get-api-:product-:cycle.json) | **GET** /api/{product}/{cycle}.json | Single cycle details
