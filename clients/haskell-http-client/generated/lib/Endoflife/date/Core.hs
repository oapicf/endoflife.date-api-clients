...
module Endoflife.date.Core where
...
-- | display the config
instance P.Show dateConfig where
  show c =
    T.printf
...
-- | constructs a default dateConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"endoflife.date/0.1.0.0"@
--
newConfig :: IO dateConfig
newConfig = do
    logCxt <- initLogContext
    return $ dateConfig
        { configHost = "https://endoflife.date"
        , configUserAgent = "endoflife.date/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => dateConfig -> auth -> dateConfig
addAuthMethod config@dateConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: dateConfig -> IO dateConfig
...
withStderrLogging :: dateConfig -> IO dateConfig
...
withNoLogging :: dateConfig -> dateConfig
...
data dateRequest req contentType res accept = dateRequest
  { rMethod  :: NH.Method   -- ^ Method of dateRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of dateRequest
  , rParams   :: Params -- ^ params of dateRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (dateRequest req contentType res accept) NH.Method
rMethodL f dateRequest{..} = (\rMethod -> dateRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (dateRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f dateRequest{..} = (\rUrlPath -> dateRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (dateRequest req contentType res accept) Params
rParamsL f dateRequest{..} = (\rParams -> dateRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (dateRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f dateRequest{..} = (\rAuthTypes -> dateRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => dateRequest req contentType res accept -> param -> dateRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: dateRequest req contentType res accept -> param -> dateRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: dateRequest req contentType res accept -> param -> dateRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
_mkRequest :: NH.Method -- ^ Method
          ...
          -> dateRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = dateRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     dateRequest req contentType res accept
  -> [NH.Header]
  -> dateRequest req contentType res accept
...
removeHeader :: dateRequest req contentType res accept -> [NH.HeaderName] -> dateRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => dateRequest req contentType res accept -> dateRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => dateRequest req contentType res accept -> dateRequest req contentType res accept
...
addForm :: dateRequest req contentType res accept -> WH.Form -> dateRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: dateRequest req contentType res accept -> NH.Part -> dateRequest req contentType res accept
...
_setBodyBS :: dateRequest req contentType res accept -> B.ByteString -> dateRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: dateRequest req contentType res accept -> BL.ByteString -> dateRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => dateRequest req contentType res accept -> P.Proxy authMethod -> dateRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> dateRequest req contentType res accept
    -> IO (dateRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> dateConfig
  -> IO (dateRequest req contentType res accept)
_applyAuthMethods req config@(dateConfig {configAuthMethods = as}) =
  foldlM go req as
  where
