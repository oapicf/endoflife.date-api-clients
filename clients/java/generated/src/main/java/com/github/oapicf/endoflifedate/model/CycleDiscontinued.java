...
public class CycleDiscontinued extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CycleDiscontinued.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CycleDiscontinued' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CycleDiscontinued>() {
                @Override
                public void write(JsonWriter out, CycleDiscontinued value) throws IOException {
                ...
                @Override
                public CycleDiscontinued read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CycleDiscontinued: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CycleDiscontinued.schemas;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CycleDiscontinued with anyOf schemas: Boolean, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
