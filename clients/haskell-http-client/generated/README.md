## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `endoflife.date`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the endoflife.date API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Endoflife.date                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | endoflife.date                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | dateConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | dateRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Endoflife.date.Client    | use the "dispatch" functions to send requests       |
| Endoflife.date.Core      | core functions, config and request types            |
| Endoflife.date.API       | construct api requests                              |
| Endoflife.date.Model     | describes api models                                |
| Endoflife.date.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Endoflife.date.ModelLens | lenses for model fields                             |
| Endoflife.date.Logging   | logging functions and utils                         |
