...
#
package WWW::OpenAPIClient::Object::Cycle;
...
__PACKAGE__->class_documentation({description => 'Details of a single release cycle of a given product. There might be some slight variations to this depending on the product.',
                                  class => 'Cycle',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'discontinued' => {
        datatype => 'CycleDiscontinued',
        base_name => 'discontinued',
        description => '',
        format => '',
        read_only => '',
            },
