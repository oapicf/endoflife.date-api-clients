...
- **get_api_all_json**
    - *invocation:* GET /api/all.json
    - *signature:* get_api_all_json(req::HTTP.Request;) -> Vector{String}
- **get_api_product_cycle_json**
    - *invocation:* GET /api/{product}/{cycle}.json
    - *signature:* get_api_product_cycle_json(req::HTTP.Request, product::String, cycle::String;) -> Cycle
- **get_api_product_json**
    - *invocation:* GET /api/{product}.json
    - *signature:* get_api_product_json(req::HTTP.Request, product::String;) -> Vector{Cycle}
"""
module APIServer
