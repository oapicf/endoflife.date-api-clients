...
function Initialize-Cycle {
    ...
    Process {
        ...
        if (!$ReleaseDate -and $ReleaseDate.length -lt 10) {
            throw "invalid value for 'ReleaseDate', the character length must be greater than or equal to 10."
        }

        if (!$Latest -and $Latest.length -lt 1) {
            throw "invalid value for 'Latest', the character length must be greater than or equal to 1."
        }

        if (!$Link -and $Link.length -lt 1) {
            throw "invalid value for 'Link', the character length must be greater than or equal to 1."
        }
