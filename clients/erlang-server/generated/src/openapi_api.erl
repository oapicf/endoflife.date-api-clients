...
request_params('GetApiAllJson') ->
    [
    ];

request_params('GetApiProductCycleJson') ->
    [
        'product',
        'cycle'
    ];

request_params('GetApiProductJson') ->
    [
        'product'
    ];
...
request_param_info('GetApiProductCycleJson', 'product') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('GetApiProductCycleJson', 'cycle') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('GetApiProductJson', 'product') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
