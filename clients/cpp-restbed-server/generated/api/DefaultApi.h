...
public:
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, AnyType>(
        )> handler_GET_func =
            []() -> std::pair<int, AnyType>
...
protected:
    ...
    virtual std::pair<int, AnyType> handler_GET(
        );
...
public:
    ...
    std::function<std::pair<int, Cycle>(
        AnyType & product, AnyType & cycle)> handler_GET_func =
            [](AnyType &, AnyType &) -> std::pair<int, Cycle>
                { throw DefaultApiException(501, "Not implemented"); };
...
public:
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, AnyType>(
        AnyType & product)> handler_GET_func =
            [](AnyType &) -> std::pair<int, AnyType>
                { throw DefaultApiException(501, "Not implemented"); };
