...
bool Cycle::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("cycle"))))
    {
        ...
        {
            std::shared_ptr<AnyType> refVal_setCycle;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("releaseDate"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AnyType> refVal_setReleaseDate;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("eol"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AnyType> refVal_setEol;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("latest"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AnyType> refVal_setLatest;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("link"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AnyType> refVal_setLink;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("lts"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AnyType> refVal_setLts;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("support"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AnyType> refVal_setSupport;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("discontinued"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AnyType> refVal_setDiscontinued;
...
std::shared_ptr<AnyType> Cycle::getCycle() const
{
    return m_Cycle;
}

void Cycle::setCycle(const std::shared_ptr<AnyType>& value)
{
    m_Cycle = value;
    m_CycleIsSet = true;
}
...
std::shared_ptr<AnyType> Cycle::getReleaseDate() const
{
    return m_ReleaseDate;
}

void Cycle::setReleaseDate(const std::shared_ptr<AnyType>& value)
{
    m_ReleaseDate = value;
...
std::shared_ptr<AnyType> Cycle::getEol() const
{
    return m_Eol;
}

void Cycle::setEol(const std::shared_ptr<AnyType>& value)
{
    m_Eol = value;
    m_EolIsSet = true;
}
...
std::shared_ptr<AnyType> Cycle::getLatest() const
{
    return m_Latest;
}

void Cycle::setLatest(const std::shared_ptr<AnyType>& value)
{
    m_Latest = value;
    m_LatestIsSet = true;
}
...
std::shared_ptr<AnyType> Cycle::getLink() const
{
    return m_Link;
}

void Cycle::setLink(const std::shared_ptr<AnyType>& value)
{
    m_Link = value;
    m_LinkIsSet = true;
}
...
std::shared_ptr<AnyType> Cycle::getLts() const
{
    return m_Lts;
}

void Cycle::setLts(const std::shared_ptr<AnyType>& value)
{
    m_Lts = value;
    m_LtsIsSet = true;
}
...
std::shared_ptr<AnyType> Cycle::getSupport() const
{
    return m_Support;
}

void Cycle::setSupport(const std::shared_ptr<AnyType>& value)
{
    m_Support = value;
    m_SupportIsSet = true;
}
...
std::shared_ptr<AnyType> Cycle::getDiscontinued() const
{
    return m_Discontinued;
}

void Cycle::setDiscontinued(const std::shared_ptr<AnyType>& value)
{
