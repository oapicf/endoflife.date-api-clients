...
additionalProperties:
  packageGuid: '{D550380C-58B6-412C-9F19-20A40656AABA}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IGetApiAllJsonApiResponse apiResponse = await api.GetApiAllJsonAsync("todo");
...
- appVersion: 0.0.1
- appDescription: The endoflife.date v0 API is currently deprecated, please [use the endoflife.date v1 API](https://endoflife.date/docs/api/v1/).
