...
pplx::task<std::vector<utility::string_t>> DefaultApi::getApiAll_json() const
{
...
pplx::task<std::shared_ptr<Cycle>> DefaultApi::getApiProductCycle_json(utility::string_t product, utility::string_t cycle) const
{
...
pplx::task<std::vector<std::shared_ptr<Cycle>>> DefaultApi::getApiProduct_json(utility::string_t product) const
{
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        std::vector<std::shared_ptr<Cycle>> localVarResult;
        ...
        if(localVarResponseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            for( auto& localVarItem : localVarJson.as_array() )
            {
                std::shared_ptr<Cycle> localVarItemObj;
                ModelBase::fromJson(localVarItem, localVarItemObj);
                localVarResult.push_back(localVarItemObj);
            }
        }
