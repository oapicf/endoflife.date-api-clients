...
validate_response('get-api-all.json', 200, Body, ValidatorState) ->
    validate_response_body('list', 'string', Body, ValidatorState);
validate_response('get-api-:product-:cycle.json', 200, Body, ValidatorState) ->
    validate_response_body('cycle', 'cycle', Body, ValidatorState);
validate_response('get-api-:product.json', 200, Body, ValidatorState) ->
...
request_params('get-api-all.json') ->
    [
    ];
request_params('get-api-:product-:cycle.json') ->
    [
        'product',
        'cycle'
    ];
request_params('get-api-:product.json') ->
    [
        'product'
    ];
request_params(_) ->
...
request_param_info('get-api-:product-:cycle.json', 'product') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('get-api-:product-:cycle.json', 'cycle') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('get-api-:product.json', 'product') ->
    #{
        source => binding,
        rules => [
            {type, binary},
