...
module OpenAPIClient
  ...
  class Cycle
    ...
    # Optional properties
    # Release Cycle
    @[JSON::Field(key: "cycle", type: Object?, nillable: true, emit_null: false)]
    property cycle : Object?

    # Release Date for the first release in this cycle
    @[JSON::Field(key: "releaseDate", type: Object?, nillable: true, emit_null: false)]
    property release_date : Object?

    # End of Life Date for this release cycle
    @[JSON::Field(key: "eol", type: Object?, nillable: true, emit_null: false)]
    property eol : Object?

    # Latest release in this cycle
    @[JSON::Field(key: "latest", type: Object?, nillable: true, emit_null: false)]
    property latest : Object?

    # Link to changelog for the latest release, if available
    @[JSON::Field(key: "link", type: Object?, nillable: true, emit_null: false)]
    property link : Object?

    # Whether this release cycle has long-term-support (LTS). Can be a date instead in YYYY-MM-DD format as well if the release enters LTS status on a given date. 
    @[JSON::Field(key: "lts", type: Object?, nillable: true, emit_null: false)]
    property lts : Object?

    # Whether this release cycle has active support
    @[JSON::Field(key: "support", type: Object?, nillable: true, emit_null: false)]
    property support : Object?

    # Whether this cycle is now discontinued.
    @[JSON::Field(key: "discontinued", type: Object?, nillable: true, emit_null: false)]
    property discontinued : Object?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@cycle : Object?, @release_date : Object?, @eol : Object?, @latest : Object?, @link : Object?, @lts : Object?, @support : Object?, @discontinued : Object?)
    end
    ...
    def list_invalid_properties
      ...
      if !@support.nil? && @support.to_s.size > 10
      ...
      if !@discontinued.nil? && @discontinued.to_s.size > 10
    ...
    def valid?
      ...
      return false if !@release_date.nil? && @release_date.to_s.size < 10
      return false if !@eol.nil? && @eol.to_s.size < 1
      return false if !@latest.nil? && @latest.to_s.size < 1
      return false if !@link.nil? && @link.to_s.size < 1
      return false if !@support.nil? && @support.to_s.size > 10
      return false if !@support.nil? && @support.to_s.size < 10
      return false if !@discontinued.nil? && @discontinued.to_s.size > 10
      return false if !@discontinued.nil? && @discontinued.to_s.size < 10
      true
    end
    ...
    def eol=(eol)
      if !eol.nil? && eol.to_s.size < 1
        raise ArgumentError.new("invalid value for \"eol\", the character length must be great than or equal to 1.")
      end
    ...
    def support=(support)
      if !support.nil? && support.to_s.size > 10
        raise ArgumentError.new("invalid value for \"support\", the character length must be smaller than or equal to 10.")
      end

      if !support.nil? && support.to_s.size < 10
        raise ArgumentError.new("invalid value for \"support\", the character length must be great than or equal to 10.")
      end
    ...
    def discontinued=(discontinued)
      if !discontinued.nil? && discontinued.to_s.size > 10
        raise ArgumentError.new("invalid value for \"discontinued\", the character length must be smaller than or equal to 10.")
      end

      if !discontinued.nil? && discontinued.to_s.size < 10
        raise ArgumentError.new("invalid value for \"discontinued\", the character length must be great than or equal to 10.")
      end
