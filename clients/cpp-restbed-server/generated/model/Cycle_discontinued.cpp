...
std::string Cycle_discontinued::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree Cycle_discontinued::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	return pt;
...
void Cycle_discontinued::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
}
