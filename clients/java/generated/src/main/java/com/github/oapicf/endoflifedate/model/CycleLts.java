...
public class CycleLts extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CycleLts.class.isAssignableFrom(type.getRawType())) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CycleLts>() {
                @Override
                public void write(JsonWriter out, CycleLts value) throws IOException {
                ...
                @Override
                public CycleLts read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CycleLts: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CycleLts
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CycleLts with anyOf schemas: Boolean, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of CycleLts given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CycleLts
     * @throws IOException if the JSON string is invalid with respect to CycleLts
     */
    public static CycleLts fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CycleLts.class);
    }

    /**
     * Convert an instance of CycleLts to an JSON string
     *
     * @return JSON string
     */
